  ...
  return (
    <div>
      <a href="https://knighthacks.org">
        <div class="flex justify-center align-center flex-col bg-black w-96 h-48 border-8 border-yellow-200 border-solid absolute top-2/4 left-2/4 font-medium tracking-widest cursor-pointer neon-container flicker-slower">
