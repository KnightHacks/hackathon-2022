...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // console.log(userData.me.applications);
    // console.log(
    //   userData.me.applications.filter(
    //     (application) => application.id == 1 + "-" + 1
    //   )
    // );
  });
    ...
    <ContentBox>
      ...
      {data &&
        data.hackathons.map((hackathon) => {
          return (
            <div>
              <h2 className="text-white text-xl font-extrabold mt-10">
              ...
              {userData.me.applications.filter(
                ...
                <button
                  class="w-2/4 mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  type="button"
                  onClick={() => {
                    let url = new URL(
                  ...
                  {userData.me.applications.filter(
                    ...
                    <p className="text-black bg-white p-3 rounded-xl mt-3">
                      ...
                      <span>
                        ...
                        team@knighthacks.org with any questions you might have.
                      </span>
                    </p>
                  )}
                  {userData.me.applications.filter(
